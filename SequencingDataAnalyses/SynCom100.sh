...
# Unzip sequences
export SC100_TP=/mnt/f/SequencingData/SynCom100/TimePoints/SC24
...
. $EMUWRAPPER_LOC/emu_wrapper_run_emu.sh -s $SC100_TP/fastq_qc -o $SC100_TP -d $EMU_DATABASE_DIR -c "TRUE" -p /mnt/f/16Sdatabases/LaCa16copies.csv
